      ...
      <div className="config-content">
        ...
        <form onSubmit={(e) => {
          ...
          <div className="timeInput">
            ...
            <input type="number" id="initial-hours" name="initial-hours" min="0" max="23" placeholder="0" onChange={(e) => {
          ...
          <div className="timeInput">
            ...
            <input type="number" id="initial-minutes" name="initials-minutes" min="0" max="59" placeholder="0" onChange={(e) => {
          ...
          <div className="timeInput">        
            ...
            <input type="number" id="final-hours" name="final-hours" min="0" max="23" placeholder="23" onChange={(e) => {
          ...
          <div className="timeInput">   
            ...
            <input type="number" id="final-minutes" name="final-minutes" min="0" max="59" placeholder="59" onChange={(e) => {
          ...
          <div className="timeInput">   
            ...
            <input type="number" id="step-hours" name="step-hours" min="0" max="23" placeholder="1" onChange={(e) => {
          ...
          <div className="timeInput">   
            ...
            <input type="number" id="step-minutes" name="step-minutes" step="30" min= "0" max="59" placeholder="0" onChange={(e) => {
